  ...
  return (
    <main>
      ...
      <div className="card">
        ...
        <p>
          Protein: <b>{fmt1(totals.protein_g)} g</b> ·
          {' '}Carbs: <b>{fmt1(totals.carbs_g)} g</b> ·
          {' '}Fat: <b>{fmt1(totals.fat_g)} g</b> ·
          {' '}Fiber: <b>{fmt1(totals.fiber_g)} g</b>
        </p>
      </div>
      ...
      <div className="card">
        ...
        {/* Energy */}
        <ProgressRow label="Energy" unit="kcal" consumed={totals.calories} target={targets.calories || 0} />
        {/* Protein */}
        <ProgressRow label="Protein" unit="g" consumed={totals.protein_g} target={targets.protein_g || 0} />
        {/* Carbs */}
        <ProgressRow label="Carbs" unit="g" consumed={totals.carbs_g} target={targets.carbs_g || 0} />
        {/* Fat */}
        <ProgressRow label="Fat" unit="g" consumed={totals.fat_g} target={targets.fat_g || 0} />
        {/* Fiber ✅ */}
        <ProgressRow label="Fiber" unit="g" consumed={totals.fiber_g} target={targets.fiber_g || 0} />
              ...
              <div key={e.id} className="card">
                <div className="row" style={{ justifyContent: 'space-between', alignItems: 'baseline' }}>
                  <div>
                    ...
                    <div className="small">
                      P {(e.protein_mg / 1000).toFixed(1)}g ·
                      {' '}C {(e.carbs_mg / 1000).toFixed(1)}g ·
                      {' '}F {(e.fat_mg / 1000).toFixed(1)}g ·
                      {' '}Fib {(e.fiber_mg / 1000).toFixed(1)}g
                    </div>
                  </div>
